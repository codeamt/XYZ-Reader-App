    ...
    private final SharedElementCallback mCallback = new SharedElementCallback() {
        ...
        public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            if(mTmpReturnState != null) {
                int prePostition = mTmpReturnState.getInt(PRE_TRANSITION_POSITION);
                int postPosition = mTmpReturnState.getInt(POST_TRANSITION_POSITION);
                if(prePostition != postPosition) {
                    String updateTransitionName = getString(R.string.transition_picture)+ prePostition;
